...
class Wilderness extends PluginBase{
	...
	public function onEnable() : void{
	    ...
	    $this->getLogger()->info("Wilderness Starting..");
	    $this->getLogger()->notice("created by musquit, configured by princepines, exclusively for PMnS");
	...
	public function onDisable() {
	    $this->getLogger()->info("Wilderness Disabling...");
	    $this->getLogger()->notice("created by musquit, configured by princepines, exclusively for PMnS");
    }
